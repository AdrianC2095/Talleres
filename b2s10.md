...
object SumaReactivaNumeros extends App {
  ...
  val observer = suma.changed.observe(sumaNueva => println(s"La Suma actual es: $sumaNueva"))
...
<img width="363" height="135" alt="image" src="https://github.com/user-attachments/assets/91253e0b-b0e4-49c8-9a68-61afa9d01ed1" />
